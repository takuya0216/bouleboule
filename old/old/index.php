<?php get_header(); ?>
    <div class="main-view">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top_img.png" alt="トップ画像">
      ...
      <div class="main-view-text font-mintyo">
  ...
  <main>
      ...
      <div class="about-inner wp-inner">
        <div class="about-text">
          <div class="about-text-inner">
            <h3>BOULE BOULEのケーキは</h3>
            <p>BOUL BOULでは、フルーツにこだわり Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores fugit iure nisi animi recusandae consectetur, ipsum corporis saepe officiis, voluptatibus totam eius dolorum officia ad debitis laboriosam accusamus, porro veniam! Lorem ipsum dolor sit amet consectetur </p>
    ...
    <section id="birthday">
      <div class="birthday-inner wp-inner">
        <h2 class="section-header font-mintyo">BIRTHDAY</h2>
    ...
    <section id="lineup">
      <div class="lineup-inner wp-inner">
        <h2 class="section-header font-mintyo">LINEUP</h2>
    ...
    <section id="gallery">
      <h2 class="section-header font-mintyo">GALLERY</h2>
